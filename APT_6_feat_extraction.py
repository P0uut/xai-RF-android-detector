...
def features_extractor(apks_directory, single_analysis, dynamic_analysis_folder, virus_total_reports_folder,
    ...
    if export_csv is not None:
        ...
        for apk_key in tqdm(database.keys()):
            ...
            '''
            #complete_row = [label] + list_apk_name_filled + list_permissions_filled + list_opcodes_filled + list_apicalls_filled + \
            ...
            complete_row = [label] + list_apk_name_filled + list_permissions_filled + list_apicalls_filled #+ \
                        #list_api_packages_filled #+ \
                        #flowdroid_fields_matrix_filled
        ...
        #complete_list_fields = ["label"] + ["APK Name"] + list_permissions + list_opcodes + list_apicalls + \
        ...
        complete_list_fields = ["label"] + ["APK Name"] + list_permissions + list_apicalls #+ \
               #list_api_packages #+ #flowdroid_fields_matrix_strings
